...
const I18N = {
  en: {
    ...
    sessionsHeld: "Sessions Held", sfOnboarding: "Governance",
    meetingsT: "Meetings Held", meetingsSub: "8 sessions completed · MOMs issued · Actions in progress",
    ...
    sfT: "Salesforce — Current Status Update", sfSharedT: "Discovery Progress", sfDecT: "Next Step",
  ...
  ar: {
    ...
    navWorkstream: "مسار العمل", navSalesforce: "Salesforce", navDecisions: "القرارات والمخاطر", navActions: "الإجراءات",
    ...
    sessionsHeld: "جلسات منعقدة", sfOnboarding: "الحوكمة",
    meetingsT: "الاجتماعات المنعقدة", meetingsSub: "اكتملت 8 جلسات · صدرت محاضر الاجتماعات · الإجراءات قيد التنفيذ",
    ...
    sfT: "Salesforce — تحديث الحالة الحالية", sfSharedT: "تقدّم مرحلة الاكتشاف", sfDecT: "الخطوة التالية",
