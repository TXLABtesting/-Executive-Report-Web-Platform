...
export const demandReport = {
  id: "demand-2026-09-09",
  href: "ministry-project-demand.html",
  pdf: "uploads/project-demand-status-report.pdf",
  title: "Project & Demand Status Report",
  subtitle: "Weekly Update · Wednesday, 9 September 2026",
  org: "Ministry of Cabinet Affairs",
  dept: "Digital Transformation Department · Confidential",
  date: "9 September 2026",
  overallStatus: "In Progress",
  summary: "Portfolio of 97 items — 73 projects & enhancements, 24 demands, 38 live in production — across entities / sectors. Near-term go-lives: Org Structure (31 Aug), GSR Platform Enhancements, UAE GLP Website Revamp and Candidate Recruitment (30 Sep), UGAM Agentic AI Platform (2 Nov).",
  stats: [
    { n: "97", label: "Total Projects", sub: "All projects, releases & demands" },
    { n: "73", label: "Projects & enhancements", sub: "Active deliveries & releases" },
    { n: "24", label: "Demands", sub: "Backlog & requests" },
    { n: "38", label: "Live", sub: "Currently in production" },
  ],
  entities: [
    { name: "CSS", n: 52 }, { name: "PMO", n: 17 }, { name: "WGS", n: 8 }, { name: "GSOC", n: 6 },
  ...
  sections: [
    { id: "projects", num: "01", title: "Projects", groups: [
      { label: "Banan", items: [
        ...
        P("GSR Platform Enhancements", "PMO", "On Track",
          ["The UAT document will be received at the end of this week, along with new features to be added in phase 3"],
          ["Have a meeting with the vendor to discuss the new features"], "30 Sep 2026",
          "Enhancements in the UX and workflow in the GSR system"),
        P("Gov Survey Upgrade", "PMO", "On Track",
          ["The vendor sent the updated configuration for us to deploy", "We provisioned ten databases"],
          ["Complete the deployment and start vendor functionality testing"], "19 Oct 2026",
          "Upgrade of the Gov Survey tool"),
        P("MBRGEA", "Performance & Govt Excellence", "On Track",
          ["AI insight, AI summarization and the KPI print dashboard UAT document have been shared with the business for testing"],
          ["Share the business feedback with the vendor and proceed with the deployment"], "26 Oct 2026",
        ...
        P("MOCA Ride", "CSS", "Delayed by Business",
          ["The business requested a change to the approval process after a request is submitted and shared with the vendor; the business will confirm whether to proceed"],
        ...
        P("Talent Management System Design", "CSS", "On Track",
          ["Design is complete; we are waiting for documentation from TenTwenty so the development vendor can start work"],
          ["Hold another meeting between Kalvad and TenTwenty"], "14 Oct 2026",
        ...
        P("UGAM Agentic AI Platform", "CSS", "On Track",
          ["Access to our server has been granted to the vendor team", "Received the updated architecture and the security questionnaire for the app from the vendor", "Met with TDRA about registration portal integration with UAE PASS"],
          ["Finalize the first milestone after management approval", "Get an update on milestone 2", "Schedule a meeting to proceed with milestone 3 — Scheduling & Allocation / Agenda"], "2 Nov 2026",
      ...
      { label: "Zeyad", items: [
        P("AI Board Observer – Cabinet", "GSOC", "On Track",
          ["System has been launched successfully during the Cabinet meeting", "Restore the previous setup so that any agenda item added, deleted or updated in the Smart Majlis is automatically reflected in the AI system", "Once the meeting brief has been reviewed, updated and approved by H.E. Khalid AlHarmoodi or myself, the AI system should not make any further changes"],
          [], "31 Jan 2026 — pending top management decision",
        ...
        P("Digital Experience of the Code", "Government Service Sector", "In Progress",
          ["Send the application to the cybersecurity team to verify and check and provide their feedback", "Send the technical documentation to the system & application team to start the hosting", "Requesting a technical meeting with vendor and IT team to agree on the hosting approach"],
          ["Technical meeting with vendor and IT team to agree on the hosting approach", "Provide the new system architecture to be sent to the cyber team for their approval"], "TBD — plan not yet submitted by the vendor",
        ...
        P("E-Cabinet System 2.0", "GSOC", "On Track",
          ["Working on data migration for current eCabinet activity with both vendors and preparing the infrastructure for documents migration", "Prepare the AI integration with the vendor to present it to HE Khalid"],
          ["Present the AI integration approach with the suggested use cases to Khalid", "Verify the files migration with the vendor with help from the SharePoint specialist"], "31 Oct 2026",
        ...
        P("GovTech Radar", "Government Service Sector", "In Progress",
          ["Agree on the hosting approach with business to move the application from AWS to FedNet to meet the integration points: Khadamati, Tawasul 171, NCRM, RUM, Mystery Shopper, Service Observatory, Customer Pulse", "Align with our IT team about the FedNet hosting option by providing them all the required documentation"],
          ["Technical meeting with the system and application team to agree on the app migration plan", "Fill the FedAI onboarding form to use the FedNet AI service"], "31 Oct 2026"),
        P("MBRGS Application", "PMO", "In Progress",
          ["Held a review meeting with MBRGS to discuss the final design for the website; MBRGS requested minor adjustments related to the overall flow", "MBRGS requested additional changes to the website design; our design team has incorporated these changes", "MBRGS reviewed the website and portal design and, following their feedback, confirmed that IT Max Global can proceed with the BRD"],
          ["Proceed with completing the BRD", "Prepare and share the UAT access links with MBRGS for their review ahead of launch", "Adjust the project plan once the BRD is finalized and share the updated details with MBRGS"], "31 Dec 2026",
        ...
        P("Org Structure", "PMO", "On Track",
          ["Completing work on the changes requested in UAT; all the must-have points have been done", "Requesting advice from business for the go-live date", "Production environment setup (for UAT readiness)"],
          ["Waiting for business users' approval on go-live"], "31 Aug 2026",
        ...
        P("UAE GLP Website Revamp", "Govt Leadership & Talent", "On Track",
          ["Website development is complete; the staging environment is done and the solution has been deployed to https://uaeglp-stg.moca.gov.ae", "Sending to business users to test and confirm in order to move it to production", "CAB meeting is scheduled after we get the confirmation from business users to go live"],
          ["Design approval required for the new logo"], "30 Sep 2026",
    ...
    { id: "mocasmart", num: "02", title: "MOCASmart", groups: [
      { label: "Active releases", items: [
        P("Release 5 – Business Mission", "CSS", "On Track",
          ["The changes have been completed, and business testing is scheduled for Thursday based on business availability"],
          ["Get business feedback and proceed accordingly"], "21 Sep 2026",
    ...
    { id: "demands", num: "03", title: "Demands", groups: [
      { label: "Banan", items: [
        ...
        P("MBRGEA Agentic AI", "PMO", "Under Scope Analysis",
          ["The final SOW has been shared with the business and the Kalvad team to schedule a meeting and align on next steps"],
          ["Get a proposal from the Kalvad team"], "—"),
        P("SKGEP Enhancement", "PMO", "Under Scope Analysis",
          ["Received feedback from Kalvad: rebuild the web rather than perform the enhancement because the site uses old technology", "Asked the vendor to submit their proposal"],
          ["Receive a proposal and proceed accordingly"], "—"),
        P("Talent Management System / Development", "CSS", "Under Scope Analysis",
          ["Waiting for TenTwenty to share the document so we can finalize the scope"],
      ...
      { label: "Noura", items: [
        ...
        P("Demand & Digital Transformation Services in MOCA App", "CSS", "Under Scope Analysis",
          ["We had a meeting with the Kalvad team to go through the design and SOW", "We need to check with business whether we will use Ivanti or Jira", "Check if we will use the AI chatbot for the project requests"],
          [], "—"),
        ...
        P("Store Management System", "CSS", "RFI",
          ["Proposals comparison submitted to business"],
          ["We are waiting for business directions"], "—"),
      ] },
      { label: "Zeyad", items: [
      ...
      { label: "Manju", items: [
        P("Agentic AI – Finance MVP – PwC", "CSS", "Under Scope Analysis",
          ["PwC briefed on the MVP requirements for finance", "PwC requested a Budget Control and I2P demo call on Thursday 10 Sep"],
          ["Finance to confirm which process from budgeting they will use for the MVP", "Schedule the demo meeting upon confirmation"], "—"),
        P("Agentic AI – P2P MVP – 1001", "CSS", "Under Scope Analysis",
          ["Shared the relevant Oracle API access and LLM / embedding model details", "Aligned with IT and Security", "Oracle application access issue is being addressed with the networks team"],
          ["Completed APIs are being progressively handed over to the vendor (1001) for further development", "Resolve the Oracle application access issue and other impediments arising during development"], "—"),
        P("Agentic AI – P2P MVP – Cohere", "CSS", "Under Scope Analysis",
          ["Account creation completed; VPN and other relevant access permissions granted", "Alignment meetings completed with the IT, Security, Oracle and Business teams", "Shared the relevant Oracle API access and LLM details"],
          ["Initiate MVP development planning", "Resolve the Oracle application access issue and other impediments arising during development"], "—"),
        P("Agentic AI – P2P MVP – Inception", "CSS", "Under Scope Analysis",
          ["Alignment meeting held with the IT, Security and Oracle team", "Account creation in progress", "Inception to come back with an architecture and infrastructure plan for on-prem hosting"],
          ["Inception to share the security questionnaire for assessment"], "—"),
        P("Agentic AI – Payroll MVP – Aleria", "CSS", "Under Scope Analysis",
          ["To schedule a meeting with Aleria; we are waiting for their confirmation"],
          ["Based on the meeting outcome we will proceed"], "—"),
        P("WGS DR 2026", "WGS", "Under Scope Analysis",
          ["Initial alignment with IT, Security, TenTwenty and Evento team held", "Security Requirement Document shared with WGS", "IT team has requested a meeting with the vendor IT"],
          ["Essa to confirm the meeting schedule", "WGS to share the open IT / Security questionnaire with Innova"], "—"),
      ] },
    ] },
...
// ---- Historical snapshot: 3 September 2026 (previous live week) ----
export const demandReportSep03 = {
...
export const demandHistory = [demandReportSep03, demandReportAug27, demandReportAug19, demandReportAug12, demandReportAug05, demandReportJul31, demandReportPrev];
