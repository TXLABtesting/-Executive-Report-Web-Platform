...
"sections":[{"id":"projects","num":"01","title":"Projects","groups":[{"label":"<owner name or release name or empty string>","items":[{"name":"..","entity":"..","status":"..","updates":["bullet",".."],"next":["bullet"],"outcome":"Project Outcome text or empty string","goLive":"22 July"}]}]}]}
Rules: sections use ids projects/mocasmart/demands/future matching the source sections in order; every project row becomes an item; keep ALL rows; updates/next are arrays of bullet strings ([] if em-dash/empty); "outcome" is the "Project Outcome" column verbatim ("" if em-dash/empty or if the section has no Project Outcome column, e.g. Demands); goLive "Live" for live items, "TBD" if unknown; derive status: empty updates + Live go-live => "Live"; "Closed" rows => "Closed"; "On Hold" => "On Hold"; "Not yet started" => "Not Started"; awaiting/pending direction => "Pending"; otherwise "In Progress".`;
